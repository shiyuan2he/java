...
//                    log.info("比较{}跟{}，{}>{},交换位置", arrayA[j], arrayA[j+1], arrayA[j], arrayA[j+1]);
                    SortUtils.swap(arrayA, j, j+1);
//                    log.info("交换后数组：{}", Arrays.toString(arrayA));
                }else{
//                    log.info("比较{}跟{}，{}<{},不交换位置 , 数组：{}", arrayA[j], arrayA[j+1], arrayA[j], arrayA[j+1], Arrays.toString(arrayA));
                }
            }
...
//                    log.info("比较{}跟{}，{}>{},交换位置", arrayA[i], arrayA[i+1], arrayA[i], arrayA[i+1]);
...
//                    log.info("比较{}跟{}，{}>{},交换位置", arrayA[i-1], arrayA[i], arrayA[i-1], arrayA[i]);
