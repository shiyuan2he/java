...
import org.hsy.java.exercise.volatiles.Counter;
...
public class CounterTest {
    private static final Logger _logger = LoggerFactory.getLogger(org.hsy.java.exercise.volatiles.CounterTest.class) ;
