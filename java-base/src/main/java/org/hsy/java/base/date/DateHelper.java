 ...
 */
package org.hsy.java.base.date;
...
public class DateHelper {
    ...
    public static String dateBetween(Date start, Date end, TimeUnit timeUnit){
        if(null==start || null==end || null == timeUnit){
            return "";
        }
        ...
        if (timeUnit.equals(TimeUnit.DAYS)) {
            ...
            long difDivideCount = diff / hours;
            if(difDivideCount < 24L){
                return difDivideCount + "小时前";
            }else {
                return (difDivideCount / 24L) + "天前";
            }
        }
        return "";
    }
