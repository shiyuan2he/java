 ...
 * @path: javase-common/com.javase.util/NumberFormatHelper.java
 * @price ￥：5元
...
public class NumberFormatHelper {
    ...
    public static String getTwoFromNum2(String num){
        BigDecimal newValue = new BigDecimal(num);
        // 保留两位小数，四舍五入
        newValue.setScale(2, BigDecimal.ROUND_HALF_UP);
        return newValue.divide(new BigDecimal(100)).toString();
    }
