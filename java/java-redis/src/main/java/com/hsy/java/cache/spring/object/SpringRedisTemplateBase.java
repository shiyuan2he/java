package com.hsy.java.cache.spring.object;

import com.askingdata.y.config.eum.CacheEnum;
import com.askingdata.y.exception.CacheException;
import com.askingdata.y.util.redis.impl.spring.SpringRedisBase;
 ...
 */
@Slf4j
public abstract class SpringRedisTemplateBase extends SpringRedisBase {
