...
import com.hsy.java.cache.spring.SpringRedisBase;
 ...
 */
@Slf4j
public abstract class StringRedisTemplateBase extends SpringRedisBase {
    // 子类实现以下数据类型
    abstract ValueOperations<String, String> getValueOperations();
    abstract ListOperations<String, String> getListOperations();
    abstract SetOperations<String, String> getSetOperations();
    abstract ZSetOperations<String, String> getzSetOperations();
    abstract HashOperations<String, String, Object> getHashOperations();
    abstract ClusterOperations<String, String> getClusterOperations();
    abstract GeoOperations<String, String> getGeoOperations();
    abstract HyperLogLogOperations<String, String> getHyperLogLogOperations();
