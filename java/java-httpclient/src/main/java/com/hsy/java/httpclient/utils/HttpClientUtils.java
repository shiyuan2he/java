package com.hsy.java.httpclient.utils;
...
/**
 * @author heshiyuan
 * @description <p>httpclint客户端</p>
 * @date 2017/7/22 11:23
...
public class HttpClientUtils {
    ...
    /**
     *
     * @description <p>获取httpclient客户端</p>
     * @returnType CloseableHttpClient 可自动关闭资源的httpClient
     * 方法名:getHttpClient
     * 类名:HttpClientUtil
     * @author heshiyuan
     * @email shiyuan4work@sina.com
     * @date 2017/7/22 13:50
     * @price ￥:5毛
    ...
    /**
     * @description <p>发送http请求</p>
     * @returnType String
     * 方法名:sendHttpGet
     * 类名:HttpClientUtil
     * @author heshiyuan
     * @email shiyuan4work@sina.com
     * @date 2017/7/22 11:47
     * @price ￥:5毛
     * @copyright	此方法版权归本人所有，复制或者剪切请通知本人或者捐赠 通知方式：shiyuan4work@sina.com
     * @callnumber 15910868535
     */
    private static String send(HttpGet httpGet,HttpPost httpPost) {
